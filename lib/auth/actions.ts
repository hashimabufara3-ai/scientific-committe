...
export async function forgotPassword(
  ...
  /* Native Supabase password reset: the recovery link always goes to the
     account's PRIMARY auth email (auth.users.email) via the standard
     resetPasswordForEmail() flow — never to any external address. */
